...
.json-to-go-page .cm-container .cm-editor {
  height: 100%;
  font-size: 0.875rem;
}

.json-to-go-page .cm-container .cm-editor.cm-focused {
  outline: none;
}

:not([data-theme="dark"]) .json-to-go-page .cm-container .cm-editor {
  background: var(--color-base-300);
}
:not([data-theme="dark"]) .json-to-go-page .cm-container .cm-editor .cm-gutters {
  background: var(--color-base-300);
  border-right: 1px solid var(--color-base-100);
}
:not([data-theme="dark"]) .json-to-go-page .cm-container .cm-editor .cm-activeLineGutter {
  background: var(--color-base-200);
}
:not([data-theme="dark"]) .json-to-go-page .cm-container .cm-editor .cm-activeLine {
  background: var(--color-base-200);
}
</style>
