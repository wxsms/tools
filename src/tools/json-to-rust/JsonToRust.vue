<template>
  <div class="json-to-rust-page">
    ...
    <div class="flex gap-4">
      ...
      <div class="flex-1 form-control min-w-0">
        <label class="label mb-2">
          <span class="label-text font-semibold">Rust 输出</span>
          <button
            v-if="output"
            class="btn btn-ghost btn-xs gap-1"
...
<style>
.json-to-rust-page .cm-container {
...
.json-to-rust-page .cm-container .cm-editor {
  height: 100%;
  font-size: 0.875rem;
}

.json-to-rust-page .cm-container .cm-editor.cm-focused {
  outline: none;
}

:not([data-theme="dark"]) .json-to-rust-page .cm-container .cm-editor {
  background: var(--color-base-300);
}
:not([data-theme="dark"]) .json-to-rust-page .cm-container .cm-editor .cm-gutters {
  background: var(--color-base-300);
  border-right: 1px solid var(--color-base-100);
}
:not([data-theme="dark"]) .json-to-rust-page .cm-container .cm-editor .cm-activeLineGutter {
  background: var(--color-base-200);
}
:not([data-theme="dark"]) .json-to-rust-page .cm-container .cm-editor .cm-activeLine {
  background: var(--color-base-200);
}
</style>
