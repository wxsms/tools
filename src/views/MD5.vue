<template>
  <div>
    <h1 class="text-3xl font-bold mb-6">MD5 哈希</h1>
    <div class="flex flex-col gap-4 max-w-2xl">
      ...
      <div class="form-control">
        ...
        <div class="relative">
          <input v-model="output" class="input input-bordered w-full font-mono text-sm" readonly />
          <button v-if="output" class="btn btn-ghost btn-xs btn-square absolute right-2 top-1/2 -translate-y-1/2" @click="copyOutput" :title="outputCopied ? '已复制！' : '复制'">
